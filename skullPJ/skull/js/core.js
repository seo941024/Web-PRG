...
const UIC = {
    line:    "#4a4642",   // 패널 테두리 — 거의 검정에 가까운 회색
    lineDim: "#2e2c29",   // 비활성 테두리
    ...
    good:    "#7fbf8a",
    bad:     "#c06a63",
    // 패널 본체 — 두 단계 평면 색. UI "틀"은 거의 검정으로 깔고,
    // 색은 글씨·게이지·등급이 담당하게 한다(틀이 밝으면 내용이 안 읽힌다).
    panel:   ["#141313", "#0a0a09"],
    slot:    "#0d0c0c",   // 인벤토리 칸 바닥
...
const Game = {
    ...
    dbgStage: 1, dbgRound: 1,   // 관리자 스테이지 선택([F1]) 커서
