...
//   dur는 "때리는 동작이 이어지는 시간"이다. exec의 피해 판정 자체는 첫 프레임에 즉시 들어가므로
//   dur가 짧으면 긴 예고 끝에 공격이 한 프레임 번쩍하고 끝나 동작이 읽히지 않는다.
//   예고 길이의 절반 이상은 확보할 것.
    ...
    1: [
        {
            ...
            name: "도끼 내려찍기", warn: 52, dur: 34, rec: 78, kind: "cast",
            exec: (e, isP2) => {
        ...
        },
        {
            ...
            name: "몸통 박치기", warn: 34, dur: 38, rec: 60, kind: "dash",
            exec: (e) => {
        ...
        },
        {
            ...
            name: "대회전 참격", warn: 46, dur: 32, rec: 84, kind: "cast",
            warnR: [46, 150],
            exec: (e, isP2) => {
